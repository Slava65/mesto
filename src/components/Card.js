export class Card {
  constructor(data, cardSelector, handleCardClick, myId, confirmDel, handleLikeClick) {
    ...
    _setEventListeners() {
      this._cloneCard.querySelector('.element__like').addEventListener('click', () => this._handleLikeClick(this));
    ...
    _setDel = () => {
      if (this._owner !== this._myId) {
        this._cloneCard.querySelector('.element__delete').classList.add('element__delete_none');
      }
    }
